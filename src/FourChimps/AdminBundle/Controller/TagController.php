...
use FourChimps\AdminBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FourChimpsArticleBundle:Tag')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FourChimpsArticleBundle:Tag')->find($id);
     ...
     * @Method("POST")
     * @Template("FourChimpsAdminBundle:Tag:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("FourChimpsAdminBundle:Tag:edit.html.twig")
     */
